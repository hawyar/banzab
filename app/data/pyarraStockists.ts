...
export const pyarraStockists: PyarraStockist[] = [
  ...
  {
    id: 'zanay-baqal', name: 'Zanay Baqal Market', outletType: 'Market', tone: 'cream', kind: 'single',
    branches: [{ id: 'zanay-baqal', name: 'Zanay Baqal Market', mapUrl: 'https://maps.app.goo.gl/j96NnDKdz82ZkxoM6?g_st=ic' }],
  },
  {
    id: 'smoothie-season', name: 'Smoothie Season', outletType: 'Juice shop', tone: 'sage', kind: 'chain',
    branches: [
